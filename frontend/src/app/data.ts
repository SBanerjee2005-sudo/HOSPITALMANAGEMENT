...
export const hospitals: Hospital[] = [
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 8, busy: 12, unavailable: 2 },
    ...
    departments: [
      { name: "Cardiology", doctorCount: 8, availability: "Available" },
  ...
  },
  {
    ...
    location: "Shyambazar",
    specialties: ["Orthopedics", "General Medicine", "Pediatrics"],
    rating: 3.9,
    isOpen: true,
    bedsAvailable: 22,
    emergencyStatus: "Busy",
    bedInventory: [
      { type: "ICU", available: 3, busy: 10, unavailable: 1 },
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 3, busy: 8, unavailable: 1 },
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 2, busy: 6, unavailable: 1 },
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 4, busy: 7, unavailable: 1 },
      { type: "General Ward", available: 7, busy: 15, unavailable: 2 },
      { type: "Private Room", available: 4, busy: 6, unavailable: 1 },
      { type: "Emergency", available: 1, busy: 3, unavailable: 0 },
    ],
    departments: [
      { name: "Cardiology", doctorCount: 6, availability: "Available" },
      { name: "Neurology", doctorCount: 5, availability: "Available" },
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 5, busy: 9, unavailable: 1 },
  ...
  {
    id: 13,
    name: "Rabindranath Tagore International",
    location: "Mukundapur",
    ...
    departments: [
      { name: "Cardiology", doctorCount: 7, availability: "Available" },
      { name: "Neurology", doctorCount: 5, availability: "Available" },
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 3, busy: 7, unavailable: 1 },
      { type: "General Ward", available: 6, busy: 12, unavailable: 2 },
      { type: "Private Room", available: 3, busy: 5, unavailable: 1 },
      { type: "Emergency", available: 1, busy: 3, unavailable: 0 },
    ],
    departments: [
      { name: "Gynecology", doctorCount: 5, availability: "Available" },
      { name: "Pediatrics", doctorCount: 4, availability: "Available" },
      { name: "General Medicine", doctorCount: 4, availability: "Busy" },
    ],
    lat: 22.5742,
  ...
  {
    id: 15,
    name: "Suraksha Diagnostics & Hospital",
  ...
  },
  {
    ...
    departments: [
      { name: "Cardiology", doctorCount: 4, availability: "Available" },
  ...
  },
  {
    ...
    emergencyStatus: "Active",
    bedInventory: [
      { type: "ICU", available: 6, busy: 11, unavailable: 1 },
  ...
  },
  {
    ...
    departments: [
      { name: "General Medicine", doctorCount: 6, availability: "Available" },
      { name: "Orthopedics", doctorCount: 4, availability: "Available" },
      { name: "Cardiology", doctorCount: 3, availability: "Limited" },
    ],
    lat: 22.4998,
